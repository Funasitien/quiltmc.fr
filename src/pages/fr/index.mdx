...
<Home content={{}}>
  <div slot="wip">
    **Attention Voyageur !** Ce site n'est pas le site officiel de QuiltMC, mais une copie exacte de celui-ci en Français 🥖. [Voir le site officiel](https://quiltmc.org)
  </div>
  <div slot="info">
    # Le Projet Quilt
